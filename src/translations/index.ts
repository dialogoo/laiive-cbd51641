...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    promoter: {
      ...
      welcomeTitle: "help laiive to improve and lead a cultural revolution",
  ...
  es: {
    ...
    promoter: {
      ...
      welcomeTitle: "ayuda a laiive a mejorar y liderar una revolución cultural",
  ...
  it: {
    ...
    promoter: {
      ...
      welcomeTitle: "aiuta laiive a migliorare e guidare una rivoluzione culturale",
  ...
  ca: {
    ...
    promoter: {
      ...
      welcomeTitle: "ajuda laiive a millorar i liderar una revolució cultural",
